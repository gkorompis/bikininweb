                ...
                <div className="app-pages page-landing">
                    ...
                    {/* <div className={(scrolled ? `${windowWidthClass}-page-section-filler-scrolled` : `${windowWidthClass}-page-section-filler`)}>
                     ...
                     <div className={`${windowWidthClass}-page-section-filler   ${scrolled ? `${windowWidthClass}-opacity-show` : `${windowWidthClass}-opacity-hide`}` }>
                                    ...
                                    <h1 style={(pallate && pallate.appNavbarTitle)}>it's YOUR STORY, WORLDWIDE</h1> 
                    ...
                    <div className={(windowWidthClass+"-color-draping") + (isPageReady ? " section-show" : "")}>
                        <h2 className={`${scrolled ? `${windowWidthClass}-opacity-show` : `${windowWidthClass}-opacity-hide`}`} style={(pallate && pallate.appNavbarTitle)}>coba klik salah satu colorbox</h2>
